...
const KPIS = [
  { label: "Total Earnings", hint: "Accumulated across all networks" },
  { label: "Pending Commission", hint: "Awaiting validation" },
  { label: "Clicks", hint: "All networks, selected period" },
  { label: "Conversions", hint: "All networks, selected period" },
];

/**
 * Accumulated earnings across every affiliate network. Live figures populate as
 * each network's reporting API is connected (see /lib/networks.ts).
 */
